...
import { PauseButtonOverlay } from "./scenes/PauseButtonOverlay";
...
const config: Phaser.Types.Core.GameConfig = {
  ...
  scene: [BootScene, TitleBackgroundScene, TitleScene, AutoTestScene, SingleVersusScene, HUDScene, PauseButtonOverlay, PauseScene],
};
